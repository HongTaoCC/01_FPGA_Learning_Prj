...
#
# Script generated by Vivado on Sun May 05 22:21:19 +0800 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/01_CodeLearning/01_FPGA_Verilog_Prj/02_LEDBlink_20240505/02_Project/LED_Blink/LED_Blink.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
